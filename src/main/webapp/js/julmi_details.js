...
function showSelection() {
	...
	if (option1 !== '버전 선택' && option2 !== '외형 선택') {
		if (selectedOptions1.length === 0) {
			...
			newOption.innerHTML = '버전: ' + option1 + ' / 외형: ' + option2 + ' <input id="remove" type="button" value=" ✕ " onclick="removeOption(\'' + optionKey + '\')"> <br><span id="amount_'
				+ optionKey + '">' + ((basicPrice + options[optionKey].price2) * options[optionKey].quantity) + '원 </span> <input id="minMax" type="button" value="-" onclick="changeQuantity(\''
			...
			// 옵션 선택란 초기화
			document.getElementById('option1').value = '버전 선택';
			document.getElementById('option2').value = '외형 선택';
			...
			var newOption = document.createElement('div');
			newOption.innerHTML = '사이즈: ' + option1 + ' / 외형: ' + option2 + ' <input id="remove" type="button" value=" ✕ " onclick="removeOption(\'' + optionKey + '\')"> <br><span id="amount_'
				+ optionKey + '">' + ((basicPrice + options[optionKey].price2) * options[optionKey].quantity) + '원 </span> <input id="minMax" type="button" value="-" onclick="changeQuantity(\''
				+ optionKey + '\', -1)"> <span id="quantity_' + optionKey + '">' + options[optionKey].quantity + '</span> <input id="minMax" type="button" value="+" onclick="changeQuantity(\''
				+ optionKey + '\', 1)"><hr id="optionHr">';
