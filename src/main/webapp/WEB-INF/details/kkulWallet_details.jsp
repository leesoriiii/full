...
<div class="details">
<h3>멍퉁망퉁 와따뀰 카드지갑 폭닥폭닥 개성만점 니트지갑</h3>
<h4 style="text-align: right;">23,000원</h4>
...
<br>
<hr>
<img src="../img(details)/kkulWallet.png" alt="Details Page Image" style="margin-top:50px;">
...
<script src="../js/kkulWallet_details.js"></script>
</body>
</html>