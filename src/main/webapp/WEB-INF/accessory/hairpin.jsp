...
<link rel="stylesheet" href="../css/accessory_hairpin.css">
</head>
<body>
	<h1>헤어핀</h1>
	<div id="header">
		<p id="list" style="margin-bottom: 0px; color: #FFFFFF;">
			악세사리 > <span style="color: #f38400; text-decoration: underline;">헤어핀 </span>
		</p>
		<hr>
		</div>
	...
	<script src="../js/accessory_hairpin_slideShow.js"></script>
