...
<link rel="stylesheet" href="../css/accessory_smart_tok.css">
</head>
<body>
	<h1>스마트톡</h1>
	<div id="header">
		<p id="list" style="margin-bottom: 0px; color: #FFFFFF;">
			악세사리 > <span style="color: #f38400; text-decoration: underline;">스마트톡 </span>
		</p>
		<hr>
		</div>
	...
	<script src="../js/accessory_smart_tok_slideShow.js"></script>
